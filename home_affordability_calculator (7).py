...
def save_results(total_sale_price, loan_amount, cash_to_close, m
import streamlit as st

# Loan formula setup and max limits
loan_formulas = {
    "C.3.0 – 3% down/closing costs out of pocket": {"down_payment": 3, "seller_concession": 0, "max_ltv": 97},
    "C.3.3 – 3% down/3% seller credit towards closing costs": {"down_payment": 3, "seller_concession": 3, "max_ltv": 97},
...
if st.session_state.button_clicked:
    ...
    if seller_concession_pct > max_seller_concession:
        st.markdown(f'<div style="background-color:red; color:white; padding:10px; font-size:16px;">'
                    ...
                    unsafe_allow_html=True)
onthly_payment, total_monthly_payment):
    results = {
